...
void Password(void)
{
	...
	send_char('\r');
	send_char('\n');
	if ((pwd[1]=='1') && (pwd[3]=='2') && (pwd[5]=='3') && (pwd[7]=='4'))
	{
	...
	else if ((pwd[0]=='2') && (pwd[2]=='3') && (pwd[4]=='4') && (pwd[6]=='5')&& (pwd[8]=='6') )
	{
	...
	else if ((pwd[0]=='2') && (pwd[1]=='3') && (pwd[2]=='4') && (pwd[3]=='5')&& (pwd[4]=='4') && (pwd[5]=='5'))
	{
